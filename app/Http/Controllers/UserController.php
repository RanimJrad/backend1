...
class UserController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/api/recherche-candidats",
     *     summary="Rechercher des candidats non archivés",
     *     description="Recherche des candidats non archivés selon le nom et/ou prénom.",
     *     tags={"Candidat"},
     *     @OA\Parameter(
     *         name="nom",
     *         in="query",
     *         required=false,
     *         @OA\Schema(type="string", example="Martin")
     *     ),
     *     @OA\Parameter(
     *         name="prenom",
     *         in="query",
     *         required=false,
     *         @OA\Schema(type="string", example="Paul")
     *     ),
     *     @OA\Response(
     *         response=200,
